  ...
  tiers: [
    {
      ...
      features: [
        ...
        "Daily briefing, living Presence face, VR room and health record included",
        "<strong>The whole world, not a cheaper slice of it</strong> — all 17 map layers, aircraft to archaeology, plus a written curriculum behind each one that runs with no internet",
        "Audit trail of account events — sign-ins, password and access changes — on your instance, readable by you",
    ...
    },
    {
      ...
      features: [
        ...
        "<strong>One seat, one owner</strong> — your own colleague, not a chat room · reversible shared workspace + audit trail of every consequential action",
        "The office half of the same trio — same minds, professional demeanor, real duties",
    ...
    },
    {
      ...
      model: "Dedicated private model on demand · 1 seat",
      features: [
        ...
        "Tamper-evident audit log · <strong>OIDC single sign-on</strong> (Google Workspace, Entra, Okta) — sign in with corporate identity",
